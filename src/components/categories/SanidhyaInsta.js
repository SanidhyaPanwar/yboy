	...
	return (
		<section className="experience" id="experience">
			<div className="max-width">
				<h2 className="categoriesTitle">SanidhyaInsta - A MERN based Instagram Clone</h2>
				...
				<div className="experience-content">
					<div className="column right">
						...
						<ul>
							...
							<li>Got a chance to Had put my learnings in a fun and interesting categories</li>
